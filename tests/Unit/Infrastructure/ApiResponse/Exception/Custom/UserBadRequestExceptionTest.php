...
class UserBadRequestExceptionTest extends TocdaUnitTestCase
{
    ...
    public function testOnKernelExceptionUserBadRequestException(): void
    {
        $exceptionCustom = new UserBadRequestException();
