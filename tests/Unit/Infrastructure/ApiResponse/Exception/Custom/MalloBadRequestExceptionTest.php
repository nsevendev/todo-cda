...
class MalloBadRequestExceptionTest extends TocdaUnitTestCase
{
    ...
    public function testOnKernelExceptionMalloBadRequestException(): void
    {
        $exceptionCustom = new MalloBadRequestException();
