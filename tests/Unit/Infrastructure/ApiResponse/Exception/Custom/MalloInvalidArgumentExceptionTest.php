...
class MalloInvalidArgumentExceptionTest extends TocdaUnitTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->request = Request::create('/api/mallo');
    }

    public function testOnKernelExceptionMalloInvalidArgumentException(): void
    {
        $exceptionCustom = new MalloInvalidArgumentException();
