...
final class MalloLastnameTypeTest extends TocdaUnitTestCase
{
    private MalloLastnameType $type;
    private MySQLPlatform $platform;

    protected function setUp(): void
    {
        if (!Type::hasType('app_mallo_lastname')) {
            Type::addType('app_mallo_lastname', MalloLastnameType::class);
        }

        $this->type = Type::getType('app_mallo_lastname');
        $this->platform = new MySQLPlatform();
    }

    public function testGetName(): void
    {
        self::assertSame('app_mallo_lastname', $this->type->getName());
    }
    ...
    public function testConvertToPHPValueWithValidString(): void
    {
        ...
        self::assertInstanceOf(MalloLastname::class, $malloMessage);
    ...
    {
        $malloMessage = MalloLastname::fromValue('Hello, Database!');
